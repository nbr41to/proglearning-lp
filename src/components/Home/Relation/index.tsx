...
export const Relation = () => {
  return (
    <div className="py-12 space-y-12">
      <h2 className="text-xl font-bold text-center underline sm:text-2xl">学習に関連する内容</h2>
      <Box className="p-10 sm:p-14">
        <h3 className="text-xl text-center text-slate-700 underline">Main contents</h3>
        ...
        <p className="mx-auto max-w-2xl text-center text-slate-600 md:px-12">
      ...
      <Box className="p-10 sm:p-14">
        <h3 className="text-xl text-center text-slate-700 underline">Sub contents</h3>
