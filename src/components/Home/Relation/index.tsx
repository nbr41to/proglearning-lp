...
export const Relation = () => {
  return (
    <div className="py-10 space-y-8">
      <h2 className="mb-6 text-2xl font-bold text-center">学習に関連する内容</h2>
      <div className="p-12 bg-slate-50 rounded">
        ...
        <p className="px-12 mx-auto mt-12 mb-12 max-w-2xl text-center text-slate-600">
